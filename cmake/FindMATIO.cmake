...
FIND_PATH(MATIO_INCLUDE_DIR NAMES matio.h PATHS ${LOCAL_FRAMEWORK_EXTENSION_FOLDER}/include/ $ENV{HOME}/include)
FIND_LIBRARY(MATIO_LIBRARY NAMES matio${ARCH_TYPE} libmatio${ARCH_TYPE} PATHS ${LOCAL_FRAMEWORK_EXTENSION_FOLDER}/lib/ $ENV{HOME}/lib)

...
void TestLinearSystem::testParallelRCAlgElement()
{
    ...
    boost::scoped_ptr< electrical::ParallelRCAlg<myMatrixType> > parallel( new electrical::ParallelRCAlg<myMatrixType>(new object::ConstObj<double>( Resistance ), new object::ConstObj<double>( Capacity ), true ) );
    ...
    stateSystemGroup.mStateVector(0,0) = 1;
    while (t <15.50)
    {
        parallel->UpdateStateSystemGroup();
        t = solver.Solve();
...
void TestLinearSystem::testSingleAlgCellellement()
{
    ...
    const double ocv[4][10] = { {3.47980625000000,3.56020000000000,3.61080000000000,3.64033750000000,3.67903750000000,3.74791250000000,3.84935000000000,3.94420000000000,4.05327500000000,4.18230000000000},
    ...
    boost::shared_ptr< electrical::Cellelement< myMatrixType > > cellelem(new electrical::Cellelement< myMatrixType >(tempState, socState));

    boost::shared_ptr< object::LookupObj2dWithState<double> > tauObj1( new object::LookupObj2dWithState<double>(
                CopyToVector(tau)
                , vecRow
                , vecCol, tempState, socState) );

    boost::shared_ptr< object::LookupObj2dWithState<double> > ohmObj1( new object::LookupObj2dWithState<double>(
                CopyToVector(ohm)
                , vecRow
                , vecCol, tempState, socState) );

    boost::shared_ptr< object::LookupObj2dWithState<double> > phiObj1( new object::LookupObj2dWithState<double>(
                CopyToVector(phi)
                , vecRow 
                , vecCol, tempState, socState) );
    ...
    boost::shared_ptr< object::LookupObj2dWithState<double> > tauObj2( new object::LookupObj2dWithState<double>(
                CopyToVector(tau2)
                , vecRow 
                , vecCol, tempState, socState) );

    boost::shared_ptr< object::LookupObj2dWithState<double> > ohmObj2( new object::LookupObj2dWithState<double>(
                CopyToVector(ohm2)
                , vecRow 
                , vecCol, tempState, socState) );

    boost::shared_ptr< object::LookupObj2dWithState<double> > phiObj2( new object::LookupObj2dWithState<double>(
                CopyToVector(phi2)
                , vecRow 
                , vecCol, tempState, socState) );
    ...
    boost::shared_ptr< object::LookupObj2dWithState<double> > ocvLookup( new object::LookupObj2dWithState<double>(
                ocvLookupData
                , ocvCol
                , vecRow, socState, tempState) );

    boost::shared_ptr< object::LookupObj2dWithState<double> > rserLookup( new object::LookupObj2dWithState<double>(
                CopyToVector(rser)
                , vecRow 
                , vecCol, tempState, socState) );
